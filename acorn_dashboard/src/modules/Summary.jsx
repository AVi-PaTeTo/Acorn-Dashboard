        ...
        <div className="flex flex-col w-full">
            ...
            <div className='flex justify-between mb-8'>
                ...
                <div>
                    ...
                    <div onClick={()=> setToggle(prev => !prev)} className='h-fit flex items-center p-0.5 rounded-4xl bg-zinc-800 hover:cursor-pointer'>
            ...
            <div className='flex flex-col xl:flex-row justify-between'>
                ...
                <section className='flex flex-col font-bold gap-2 text-[.8rem] 2xl:text-[1rem] mb-5 xl:mb-0'>
                    ...
                    <span className='text-white bg-accent px-2 py-px pt-0.5 rounded-4xl font-semibold flex items-center'>
                    ...
                    <span className='flex text-white bg-accent px-2 py-px pt-0.5 rounded-4xl font-semibold'>
                        $27,335
                ...
                <section className='flex xl:text-[.8rem] 2xl:text-[1rem]'>
                    <section className='flex gap-8 mx-3 mr-6 xl:mx-6'>
                        {/* Top Sales */}
                        <div className='w-30 2xl:w-35 relative flex items-center justify-center rounded-xl bg-gray-200'>
                            <div className='absolute bg-s-white w-35 2xl:w-40 gap-1.5 flex flex-col justify-between py-2 px-4 outline-2 outline-gray-200 rounded-xl ray-300 font-bold'>
                            ...
                            <div className='flex justify-between items-center'>
                                ...
                                <span className='bg-gray-200 p-0.5 rounded-md hover:cursor-pointer'>
                        ...
                        {/* Best Deal */}
                        <div className='w-30 2xl:w-35 relative flex items-center justify-center rounded-xl bg-gray-300'>
                            <div className='absolute text-s-white w-35 2xl:w-40 gap-1.5 flex flex-col justify-between py-2 px-4 outline-2 outline-gray-200 bg-dark rounded-xl font-semibold'>
