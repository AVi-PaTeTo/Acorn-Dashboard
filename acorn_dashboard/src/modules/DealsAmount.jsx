    ...
    return(
            <div className='aspect-square flex flex-col justify-between h-full w-full max-h-70 max-w-70 bg-gray-200/70 rounded-2xl'>
                ...
                <div className='flex h-full'>
                    <div className='flex flex-1 gap-[6px] px-3 pt-5 2xl:px-4 items-end'>
                        ...
                        <span className='flex-1 h-full rounded-lg bg-white'>
                        ...
                        <span className='flex-1 h-[60%] rounded-lg bg-white'>
                            <span className='rounded-t-lg w-full aspect-square flex items-center justify-center'>
                        ...
                        <span className='flex-1 h-[45%] rounded-lg bg-white'>
                            <span className='rounded-t-lg w-full aspect-square flex items-center justify-center'>
                        ...
                        <span className='flex flex-1 h-[85%] rounded-lg bg-white'>
