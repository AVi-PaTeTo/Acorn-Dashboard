export default function DealsAmount(){
    return(
            <div className='aspect-square flex flex-col justify-between h-full w-full max-h-70 max-w-70 bg-gray-200/70 rounded-2xl'>
                <div className='flex justify-between items-center px-4 pt-4'>
                    <div className='flex gap-1 '>
                        <svg className='-rotate-90' width="20" height="20" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg"><rect x="20" y="20" width="160" height="14" rx="7" fill="black"/><rect x="20" y="70" width="120" height="14" rx="7" fill="black"/><rect x="20" y="120" width="160" height="14" rx="7" fill="black"/><rect x="20" y="170" width="80" height="14" rx="7" fill="black"/></svg>
                ...
                <div className='flex flex-col pt-1 px-3 pb-3 2xl:px-4 2xl:pb-4 xl:text-[0.8rem] 2xl:text-[0.9rem] font-bold'>
                    <span className='text-gray-400'>
                    Deals amount
                    </span>
                    <span className='flex hover:cursor-pointer'>
                        by referrer category
                        <svg className="w-5 h-5 fill-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> <path d="M8.12 9.29L12 13.17l3.88-3.88a.996.996 0 1 1 1.41 1.41l-4.59 4.59a.996.996 0 0 1-1.41 0L6.7 10.7a.996.996 0 0 1 0-1.41c.39-.38 1.03-.39 1.42 0"/></svg>
                    </span>
                </div>
            </div>
    )
