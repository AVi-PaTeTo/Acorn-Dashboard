...
const Side = () => {
    ...
    return(
        <div className="h-dvh relative">
            <div className="fixed flex flex-col items-center justify-between p-4 2xl:p-5 h-full w-17.5">
                ...
                <div className="flex flex-col gap-4 mt-auto">
                    <div className="hover:cursor-pointer w-10 h-10 flex items-center justify-center bg-s-white rounded-4xl relative">
                        <div className="absolute h-1.5 w-1.5 outline-accent outline-3 rounded-2xl top-1 right-1"></div>
