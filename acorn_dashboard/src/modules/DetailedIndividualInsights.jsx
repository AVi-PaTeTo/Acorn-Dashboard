        ...
        <span className='flex flex-col flex-1 w-full rounded-2xl h-full text-[.8rem] font-bold'>
            ...
            <div className='flex flex-col h-full'>
                <div className='flex justify-between items-center mb-2'>
                    ...
                    <span className='bg-accent gap-0.5 pr-3 pl-2 flex items-center text-white rounded-2xl'>
                        <svg className='h-3.5 w-3.5 fill-white' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 13.825L8.1 17.7q-.275.275-.687.288T6.7 17.7q-.275-.275-.275-.7t.275-.7l4.6-4.6q.15-.15.325-.213t.375-.062t.375.062t.325.213l4.6 4.6q.275.275.288.688t-.288.712q-.275.275-.7.275t-.7-.275zm0-6L8.1 11.7q-.275.275-.687.288T6.7 11.7q-.275-.275-.275-.7t.275-.7l4.6-4.6q.15-.15.325-.212T12 5.425t.375.063t.325.212l4.6 4.6q.275.275.288.688t-.288.712q-.275.275-.7.275t-.7-.275z"/></svg>
                        <p className='pt-px'>3</p>
                    </span>
                    <span className='bg-accent py-1 px-2.5 text-white rounded-2xl'>$156,841</span>
                    </span>

                </div>
                {/* Platform revs */}
                <div className='flex h-30 gap-1.5 mb-2'>
                        ...
                        <div className='absolute inset-0 '>
                            ...
                            <div className='w-full h-[15%] bottom-0 flex items-center pb-2'>
                                <div className='relative w-full h-1 bg-linear-to-r rounded-sm from-red-600 via-amber-300 to-green-500'>
                                    <span className='absolute -top-1.5 left-[20%] bg-blue-600 p-px rounded-sm'>
                                        <div className="absolute flex items-center justify-center h-3.5 w-3.5 bg-accent rounded-2xl -top-1.5 -right-1.5">
                                    ...
                                    <span className='absolute -top-1.5 left-[52%] bg-accent p-px rounded-sm'>
                                        <div className="absolute flex items-center justify-center h-3.5 w-3.5 bg-black rounded-2xl -top-1.5 -right-1.5">
                                    ...
                                    <span className='absolute -top-1.5 left-[85%]'>
                                        <div className="absolute flex items-center justify-center h-3.5 w-3.5 bg-accent rounded-2xl -top-1.5 -right-1.5">
